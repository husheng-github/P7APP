...
typedef enum
{
    AUDIO_VOL_0,      /* Volume level 0 (Not mute) */
    AUDIO_VOL_1,      /* Volume level 1 */
    AUDIO_VOL_2,      /* Volume level 2 */
    AUDIO_VOL_3,      /* Volume level 3 */
    AUDIO_VOL_4,      /* Volume level 4 */
    AUDIO_VOL_5,      /* Volume level 5 */
    AUDIO_VOL_MAX     /* Total volume level */
} AUDIO_VOL_ENUM;
