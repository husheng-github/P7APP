...
#define DDI_ELEC_SIGN_KEY_SET 5
#define DDI_ELEC_SIGN_IS_CALIBRATE 1

typedef struct{
  strRect enter_key_info;   //确认键的坐标信息
  strRect esc_key_info;     //取消键的坐标信息
  strRect clear_key_info;   //清除键的坐标信息
}elect_sign_key_set_t;
